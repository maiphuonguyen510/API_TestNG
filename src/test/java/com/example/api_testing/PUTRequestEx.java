...
public class PUTRequestEx {
    public static void PUTReq() throws IOException {
...
// closing the output stream
        ...
        System.out.println("The PUT Request Response Code :  " + respCode);
        System.out.println("The PUT Request Response Message : " + postCon.getResponseMessage());
...
// towards the response of the server
            ...
            File file = new File("output\\PUT_employees.xml");
